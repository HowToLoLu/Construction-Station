...
/obj/item/organ/external/wings/functional/Remove(mob/living/carbon/organ_owner, special, pref_load)
	. = ..()
...
/obj/item/organ/external/wings/functional/proc/can_fly(mob/living/carbon/human/human)
	...
	if(human.wear_suit && ((human.wear_suit.flags_inv & HIDEJUMPSUIT) && (!human.wear_suit.species_exception || !is_type_in_list(src, human.wear_suit.species_exception))))
		to_chat(human, "<span class='warning'>Your suit blocks your wings from extending!</span>")
		return FALSE
	...
	if(environment && !(environment.return_pressure() > 30))
		to_chat(human, "<span class='warning'>The atmosphere is too thin for you to fly!</span")
		return FALSE
	else
		return TRUE
...
/obj/item/organ/external/wings/functional/proc/fly_slip(mob/living/carbon/human/human)
	...
	to_chat(human, "<span class='notice'>Your wings spazz out and launch you!</span>")
...
/datum/action/innate/flight/Activate()
	...
	if(wings && wings.can_fly(human))
		...
		if(!(human.movement_type & FLYING))
			to_chat(human, "<span class='notice'>You settle gently back onto the ground...</span>")
		else
			to_chat(human, "<span class='notice'>You beat your wings and begin to hover gently above the ground...</span>")
...
/obj/item/organ/external/wings/moth/proc/try_burn_wings(mob/living/carbon/human/human)
	...
	if(!burnt && human.bodytemperature >= 800 && human.fire_stacks > 0) //do not go into the extremely hot light. you will not survive
		to_chat(human, "<span class='danger'>Your precious wings burn to a crisp!</span>")
